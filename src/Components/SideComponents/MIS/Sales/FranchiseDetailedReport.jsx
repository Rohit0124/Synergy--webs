...
function FranchiseDetailedReport() {
  ...
  useEffect(() => {
    const storedData = JSON.parse(localStorage.getItem("FranchiseDetailedData"));
    if (storedData && storedData.length > 0) {
      setData(storedData);
    } else {
      setData(ReceiveFuelReportData);
      localStorage.setItem("FranchiseDetailedData", JSON.stringify(ReceiveFuelReportData));
    }
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("FranchiseDetailedData", JSON.stringify(updatedData));
    setData(updatedData);
  ...
  return (
    <div className='list-container'>
      <h2>Manage Franchise Detailed Report</h2>
...
export default FranchiseDetailedReport;
