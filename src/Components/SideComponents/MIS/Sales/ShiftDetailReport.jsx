...
function ShiftDetailReport() {
  ...
  useEffect(() => {
    const storedData = JSON.parse(localStorage.getItem("ShiftDetailData"));
    if (storedData && storedData.length > 0) {
      setData(storedData);
    } else {
      setData(ReceiveFuelReportData);
      localStorage.setItem("ShiftDetailData", JSON.stringify(ReceiveFuelReportData));
    }
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("ShiftDetailData", JSON.stringify(updatedData));
    setData(updatedData);
  ...
  return (
    <div className='list-container'>
      <h2>Manage Payment Summary Report</h2>
...
export default ShiftDetailReport;
