...
function PaymentDetailReport() {
  ...
  useEffect(() => {
    const storedData = JSON.parse(localStorage.getItem("PaymentDetailData"));
    if (storedData && storedData.length > 0) {
      setData(storedData);
    } else {
      setData(ReceiveFuelReportData);
      localStorage.setItem("PaymentDetailData", JSON.stringify(ReceiveFuelReportData));
    }
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("PaymentDetailData", JSON.stringify(updatedData));
    setData(updatedData);
  ...
  return (
    <div className='list-container'>
      <h2>Manage Payment Detail Report</h2>
