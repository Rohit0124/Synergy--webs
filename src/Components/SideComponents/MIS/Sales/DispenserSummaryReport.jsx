...
function DispenserSummaryReport() {
  ...
  useEffect(() => {
    const storedData = JSON.parse(localStorage.getItem("dispenserSummaryData"));
    if (storedData && storedData.length > 0) {
      setData(storedData);
    } else {
      setData(ReceiveFuelReportData);
      localStorage.setItem("dispenserSummaryData", JSON.stringify(ReceiveFuelReportData));
    }
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("dispenserSummaryData", JSON.stringify(updatedData));
    setData(updatedData);
  ...
  return (
    <div className='list-container'>
      <h2>Manage Dispenser Summary Report</h2>
...
export default DispenserSummaryReport;
