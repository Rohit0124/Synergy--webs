...
function DispenserDetailedReport() {
  ...
  useEffect(() => {
    const storedData = JSON.parse(localStorage.getItem("dispenserDetailData"));
    if (storedData && storedData.length > 0) {
      setData(storedData);
    } else {
      setData(ReceiveFuelReportData);
      localStorage.setItem("dispenserDetailData", JSON.stringify(ReceiveFuelReportData));
    }
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("dispenserDetailData", JSON.stringify(updatedData));
    setData(updatedData);
  ...
  return (
    <div className='list-container'>
      <h2>Manage Dispenser Detail Report</h2>
...
export default DispenserDetailedReport;
