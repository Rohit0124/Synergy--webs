...
function ProductSummaryReport() {
  ...
  useEffect(() => {
    const storedData = JSON.parse(localStorage.getItem("ProductSummaryData"));
    if (storedData && storedData.length > 0) {
      setData(storedData);
    } else {
      setData(ReceiveFuelReportData);
      localStorage.setItem("ProductSummaryData", JSON.stringify(ReceiveFuelReportData));
    }
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("ProductSummaryData", JSON.stringify(updatedData));
    setData(updatedData);
  ...
  return (
    <div className='list-container'>
      <h2>Manage Product Summary Report</h2>
