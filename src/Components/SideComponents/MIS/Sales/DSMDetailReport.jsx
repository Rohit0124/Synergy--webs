...
function DSMDetailReport() {
  ...
  useEffect(() => {
    const storedData = JSON.parse(localStorage.getItem("DSMDetailData"));
    if (storedData && storedData.length > 0) {
      setData(storedData);
    } else {
      setData(ReceiveFuelReportData);
      localStorage.setItem("DSMDetailData", JSON.stringify(ReceiveFuelReportData));
    }
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("DSMDetailData", JSON.stringify(updatedData));
    setData(updatedData);
  ...
  return (
    <div className='list-container'>
      <h2>Manage DSM Detailed Report</h2>
...
export default DSMDetailReport;
