...
function DSMSummaryReport() {
  ...
  useEffect(() => {
    const storedData = JSON.parse(localStorage.getItem("DSMSummaryData"));
    if (storedData && storedData.length > 0) {
      setData(storedData);
    } else {
      setData(ReceiveFuelReportData);
      localStorage.setItem("DSMSummaryData", JSON.stringify(ReceiveFuelReportData));
    }
  }, []);
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("DSMSummaryData", JSON.stringify(updatedData));
    setData(updatedData);
  ...
  return (
    <div className='list-container'>
      <h2>Manage DSM Summary Report</h2>
...
export default DSMSummaryReport;
