...
import { CustomerData } from '../../../DataTable';
    ...
    <div>
      <div className='list-container'>
        <div className='list-bt-div'>
          <h2>Customer List</h2>
          <div>
            <button className='list-add-bt' onClick={handleClick}>Add Customer</button>
                ...
                <tr key={item.id}>
                  {editId === item.id ? (
                    <>
                      ...
                      <td><input name="mobile" value={editItem.mobile} onChange={handleEditChange} /></td>
