...
function CountryUpdateList() {
  ...
  useEffect(() => {
    const editItem = JSON.parse(localStorage.getItem("editCountryItem"));
    if (editItem) {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      localStorage.removeItem("editCountryItem");

      alert(editId ? "Entry updated successfully!" : "Form submitted successfully!");
      navigate("/generalsetting/countrylist");
    }
  };
  ...
  return (
    <div className="form-container">
      <div className='list-bt-div'>
        <h2>{editId ? 'Edit Country' : 'Country Update List'}</h2>
        <div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          {[
            ...
            { name: 'ISO2', label: 'ISO2', type: 'text', placeholder: 'Enter ISO2' },
            { name: 'ISO3', label: 'ISO3', type: 'text', placeholder: 'Enter ISO3' },
            { name: 'capital', label: 'Capital', type: 'text', placeholder: 'Enter Capital' },
...
export default CountryUpdateList;
